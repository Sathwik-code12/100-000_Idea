...
}).omit({ id: true, createdAt: true, updatedAt: true, views: true, likes: true, keyFeatures: true, isVisible: true, fullDescription: true, difficulty: true, investment: true, timeframe: true, marketSize: true, targetAudience: true, revenueModel: true, investmentRequired: true, expectedRoi: true, marketTrends: true, implementationSteps: true, isFeatured: true });
...
}).omit({ id: true, uploadedBy: true, createdAt: true, processingStatus: true, errors: true, successCount: true, errorCount: true, isDeleted: true, deletedAt: true, deletedBy: true });
